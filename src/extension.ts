...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(
    ...
    register('labwindowsCvi.context.insertFileHeader', () => templates.insertBuiltInSnippet('doc-file-header')),
    register('labwindowsCvi.context.insertCommentSection', () => templates.insertBuiltInSnippet('doc-comment-section')),
